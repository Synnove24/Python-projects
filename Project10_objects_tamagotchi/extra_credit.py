...
import turtle
import time
#creates a function that fills a circle with a given radius, potition, and color
def fill_circle(turtle, color, radius, position):
        ...
        turtle.up()
        turtle.goto(0,0)
#creates a class called tamagotchi        
class TamagotchiGame:
    #contructor function that creates a pet    
    ...
    def draw_egg(self)->None:
        """draws various circles to create character"""    
        turtle.tracer(0,0)
    ...
    def draw_baby(self)->None:
        """draws circles to create baby tamagotchi"""    
        turtle.tracer(0,0)
    ...
    def draw_child(self)->None:
        """draws circles to create child tamagotchi"""    
        turtle.tracer(0,0)
    ...
    def draw_adult(self)->None:
        """draws circles to create adult tamagotchi"""    
        turtle.tracer(0,0)
    ...
    def draw_tombstone(self)->None:
        """draws tombstone for tamagotchi"""    
        turtle.tracer(0,0)
    ...
    def display(self)->None:
        """displays tamagotchi based on stage"""    
        self.pen.clear()
        self.pen.up()
        self.pen.goto(0,-30)
        self.pen.write(self.pet.name, align = "center", font=("Arial", 20, "normal"))
        self.pen.goto(0,0)
        #decides which stage the tamagotchi is at
    ...
    def feed(self)->None:
        """Adds words for when the tamagotchi eats"""    
        self.pet.feed()
        self.display()
        self.pen.goto(0,20)
    ...
    def play(self)->None:
        """Adds words for when the tamagotchi plays"""    
        self.pet.play()
        self.display()
        self.pen.goto(0,20)
    ...
    def bathe(self)->None:
        """Adds words for when the tamagotchi bathes"""    
        self.pet.bathe()
        self.display()
        self.pen.goto(0,20)
    ...
    def run(self)-> None:
        ...
        #if the tamagotchi is alive the while loop continues
        while state != "dead":
            self.display()
            if state == "distress":
                #prints WWAHHHH!! if the state of the tamagotchi is distress    
                for i in range(2,5):
            ...
            time.sleep(1)
            state = self.pet.time_step()
        #creates tombstone when tamagotchi dies    
        self.pen.clear()
        self.draw_tombstone()
        turtle.exitonclick()
